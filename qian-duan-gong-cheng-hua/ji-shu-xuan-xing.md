...
## 二、可控性 <a href="#ke-kong-xing" id="ke-kong-xing"></a>
...
## 三、稳定性 <a href="#wen-ding-xing" id="wen-ding-xing"></a>
...
## 四、适用性 <a href="#kuo-yong-xing" id="kuo-yong-xing"></a>

适用性，是指需要根据业务场景和团队成员来选择技术。

### 1. 业务场景 <a href="#ye-wu-chang-jing" id="ye-wu-chang-jing"></a>
...
### 2. 团队成员 <a href="#tuan-dui-cheng-yuan" id="tuan-dui-cheng-yuan"></a>
...
## 五、易用性 <a href="#yi-yong-xing" id="yi-yong-xing"></a>
...
![](https://img-blog.csdnimg.cn/img\_convert/530e8075b05ea95fc8d7df9e368c3d43.png)

![](https://img-blog.csdnimg.cn/img\_convert/89078aff75b09342fb624caacde6f447.png)

易用性，决定了你的团队好不好招人，这一点对小公司和不在一线城市的公司来说非常重要。

## 六、小结 <a href="#xiao-jie" id="xiao-jie"></a>
...
![](https://img-blog.csdnimg.cn/img\_convert/78850c57f289ce23ba22851987099176.png)

虽然说前端目前只有三大框架可以选择，但技术永远是在发展的，框架也是在不断的更新迭代。学会如何进行技术选型，则不管当下流行的是什么技术，都可以减少你在进行技术选型时可能会犯的失误。

## 七、参考 <a href="#can-kao-zi-liao" id="can-kao-zi-liao"></a>

* [带你入门前端工程 - 技术选型](https://woai3c.gitee.io/introduction-to-front-end-engineering/01.html#%E5%8F%AF%E6%8E%A7%E6%80%A7)
